...
do
local figBase = part(ws, 'FigBase', 2, 1.6, 158, 2.6, 4, 2.6, {96, 66, 40}, Enum.Material.Wood, 0, true, Enum.PartType.Cylinder)
...
do local pl = part(ws, 'PathLantern0', 6, 1.9, 88, 0.55, 3.4, 0.55, {80, 66, 50}, Enum.Material.Wood, 0, true, Enum.PartType.Cylinder)
local pb = part(ws, 'PathLanternBall0', 6, 3.2, 88, 1.0, 1.0, 1.0, {255, 205, 110}, Enum.Material.Neon, 0, false, Enum.PartType.Ball)
light(pb, {255, 195, 100}, 0.9, 16)
end
do local pl = part(ws, 'PathLantern1', 2, 1.9, 116, 0.55, 3.4, 0.55, {80, 66, 50}, Enum.Material.Wood, 0, true, Enum.PartType.Cylinder)
local pb = part(ws, 'PathLanternBall1', 2, 3.2, 116, 1.0, 1.0, 1.0, {255, 205, 110}, Enum.Material.Neon, 0, false, Enum.PartType.Ball)
light(pb, {255, 195, 100}, 0.9, 16)
end
do local pl = part(ws, 'PathLantern2', -14, 1.9, 152, 0.55, 3.4, 0.55, {80, 66, 50}, Enum.Material.Wood, 0, true, Enum.PartType.Cylinder)
local pb = part(ws, 'PathLanternBall2', -14, 3.2, 152, 1.0, 1.0, 1.0, {255, 205, 110}, Enum.Material.Neon, 0, false, Enum.PartType.Ball)
light(pb, {255, 195, 100}, 0.9, 16)
end
do local pl = part(ws, 'PathLantern3', 26, 1.9, 135, 0.55, 3.4, 0.55, {80, 66, 50}, Enum.Material.Wood, 0, true, Enum.PartType.Cylinder)
local pb = part(ws, 'PathLanternBall3', 26, 3.2, 135, 1.0, 1.0, 1.0, {255, 205, 110}, Enum.Material.Neon, 0, false, Enum.PartType.Ball)
light(pb, {255, 195, 100}, 0.9, 16)
end
do
part(ws, 'BellPost1', -28, 1.4, 160, 0.7, 5, 0.7, {100, 72, 46}, Enum.Material.Wood, 0, true, Enum.PartType.Block)
part(ws, 'BellPost2', -24, 1.4, 160, 0.7, 5, 0.7, {100, 72, 46}, Enum.Material.Wood, 0, true, Enum.PartType.Block)
part(ws, 'BellBeam', -26, 3.9, 160, 5, 0.6, 0.6, {100, 72, 46}, Enum.Material.Wood, 0, true, Enum.PartType.Block)
local bell = part(ws, 'VillageBell', -26, 3.4, 160, 1.8, 1.8, 1.8, {200, 165, 70}, Enum.Material.Metal, 0, false, Enum.PartType.Ball)
part(ws, 'BellClapper', -26, 2.6, 160, 0.5, 0.8, 0.5, {120, 100, 55}, Enum.Material.Metal, 0, false, Enum.PartType.Ball)
end
part(ws, 'BenchSeat', -22, 1.0, 146, 4, 0.5, 1.4, {120, 90, 55}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'BenchLeg1', -23.2, 0.4, 146, 0.4, 1.2, 1.2, {100, 70, 45}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'BenchLeg2', -20.8, 0.4, 146, 0.4, 1.2, 1.2, {100, 70, 45}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'TavernCrate0', -50, 1.0, 144, 2, 2, 2, {140, 100, 55}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'TavernCrate1', -52, 1.0, 146, 2, 2, 2, {140, 100, 55}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'TavernCrate2', -49, 1.0, 148, 2, 2, 2, {140, 100, 55}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'DryingNet', 24, 1.2, 188, 10, 0.3, 3, {90, 130, 150}, Enum.Material.SmoothPlastic, 0.35, false, Enum.PartType.Block, 0, 0, 0.08)
part(ws, 'NetPost0', 19, 1.4, 188, 0.5, 4, 0.5, {100, 70, 45}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'NetPost1', 29, 1.4, 188, 0.5, 4, 0.5, {100, 70, 45}, Enum.Material.Wood, 0, true, Enum.PartType.Block, 0, 0, 0)
part(ws, 'PalmTrunk_BP0', 29.9, 3.4, 201.81, 0.7, 6, 0.7, {122, 82, 44}, Enum.Material.Wood, 0, false, Enum.PartType.Cylinder, -0.02, 0, 0.02)
blob(ws, 'PalmCanopy_BP0_0', 32.1, 5.4, 201.81, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 1.57)
blob(ws, 'PalmCanopy_BP0_1', 31.0, 5.88, 203.72, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 0.52)
blob(ws, 'PalmCanopy_BP0_2', 28.79, 5.66, 203.71, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -0.53)
blob(ws, 'PalmCanopy_BP0_3', 27.7, 5.06, 201.79, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -1.58)
blob(ws, 'PalmCanopy_BP0_4', 28.82, 4.96, 199.89, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -2.63)
blob(ws, 'PalmCanopy_BP0_5', 31.03, 5.51, 199.92, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -3.68)
blob(ws, 'PalmTop_BP0', 29.9, 5.8, 201.81, 2.6, 1.4, 2.6, {52, 150, 62}, Enum.Material.SmoothPlastic, 0, false)
part(ws, 'PalmNut1_BP0', 29.5, 4.9, 202.11, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmNut2_BP0', 30.3, 4.9, 201.51, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmTrunk_BP1', -34.98, 3.4, 199.3, 0.7, 6, 0.7, {122, 82, 44}, Enum.Material.Wood, 0, false, Enum.PartType.Cylinder, -0.0, 0, -0.08)
blob(ws, 'PalmCanopy_BP1_0', -32.78, 5.4, 199.3, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 1.57)
blob(ws, 'PalmCanopy_BP1_1', -33.89, 5.88, 201.21, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 0.52)
blob(ws, 'PalmCanopy_BP1_2', -36.1, 5.66, 201.2, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -0.53)
blob(ws, 'PalmCanopy_BP1_3', -37.18, 5.06, 199.28, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -1.58)
blob(ws, 'PalmCanopy_BP1_4', -36.06, 4.96, 197.38, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -2.63)
blob(ws, 'PalmCanopy_BP1_5', -33.86, 5.51, 197.41, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -3.68)
blob(ws, 'PalmTop_BP1', -34.98, 5.8, 199.3, 2.6, 1.4, 2.6, {52, 150, 62}, Enum.Material.SmoothPlastic, 0, false)
part(ws, 'PalmNut1_BP1', -35.38, 4.9, 199.6, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmNut2_BP1', -34.58, 4.9, 199.0, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmTrunk_BP2', 14.34, 3.4, 184.54, 0.7, 6, 0.7, {122, 82, 44}, Enum.Material.Wood, 0, false, Enum.PartType.Cylinder, -0.04, 0, 0.05)
blob(ws, 'PalmCanopy_BP2_0', 16.54, 5.4, 184.54, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 1.57)
blob(ws, 'PalmCanopy_BP2_1', 15.43, 5.88, 186.45, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 0.52)
blob(ws, 'PalmCanopy_BP2_2', 13.22, 5.66, 186.44, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -0.53)
blob(ws, 'PalmCanopy_BP2_3', 12.14, 5.06, 184.52, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -1.58)
blob(ws, 'PalmCanopy_BP2_4', 13.26, 4.96, 182.62, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -2.63)
blob(ws, 'PalmCanopy_BP2_5', 15.46, 5.51, 182.65, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -3.68)
blob(ws, 'PalmTop_BP2', 14.34, 5.8, 184.54, 2.6, 1.4, 2.6, {52, 150, 62}, Enum.Material.SmoothPlastic, 0, false)
part(ws, 'PalmNut1_BP2', 13.94, 4.9, 184.84, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmNut2_BP2', 14.74, 4.9, 184.24, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmTrunk_BP3', -26.68, 3.4, 184.92, 0.7, 6, 0.7, {122, 82, 44}, Enum.Material.Wood, 0, false, Enum.PartType.Cylinder, -0.07, 0, 0.04)
blob(ws, 'PalmCanopy_BP3_0', -24.48, 5.4, 184.92, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 1.57)
blob(ws, 'PalmCanopy_BP3_1', -25.59, 5.88, 186.83, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 0.52)
blob(ws, 'PalmCanopy_BP3_2', -27.79, 5.66, 186.82, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -0.53)
blob(ws, 'PalmCanopy_BP3_3', -28.88, 5.06, 184.9, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -1.58)
blob(ws, 'PalmCanopy_BP3_4', -27.76, 4.96, 183.01, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -2.63)
blob(ws, 'PalmCanopy_BP3_5', -25.55, 5.51, 183.03, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -3.68)
blob(ws, 'PalmTop_BP3', -26.68, 5.8, 184.92, 2.6, 1.4, 2.6, {52, 150, 62}, Enum.Material.SmoothPlastic, 0, false)
part(ws, 'PalmNut1_BP3', -27.08, 4.9, 185.22, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmNut2_BP3', -26.28, 4.9, 184.62, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmTrunk_BP4', 1.1, 3.4, 195.84, 0.7, 6, 0.7, {122, 82, 44}, Enum.Material.Wood, 0, false, Enum.PartType.Cylinder, -0.0, 0, -0.07)
blob(ws, 'PalmCanopy_BP4_0', 3.3, 5.4, 195.84, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 1.57)
blob(ws, 'PalmCanopy_BP4_1', 2.19, 5.88, 197.75, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 0.52)
blob(ws, 'PalmCanopy_BP4_2', -0.01, 5.66, 197.74, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -0.53)
blob(ws, 'PalmCanopy_BP4_3', -1.1, 5.06, 195.82, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -1.58)
blob(ws, 'PalmCanopy_BP4_4', 0.02, 4.96, 193.93, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -2.63)
blob(ws, 'PalmCanopy_BP4_5', 2.23, 5.51, 193.95, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -3.68)
blob(ws, 'PalmTop_BP4', 1.1, 5.8, 195.84, 2.6, 1.4, 2.6, {52, 150, 62}, Enum.Material.SmoothPlastic, 0, false)
part(ws, 'PalmNut1_BP4', 0.7, 4.9, 196.14, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmNut2_BP4', 1.5, 4.9, 195.54, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmTrunk_BP5', -15.18, 3.4, 191.97, 0.7, 6, 0.7, {122, 82, 44}, Enum.Material.Wood, 0, false, Enum.PartType.Cylinder, -0.03, 0, -0.05)
blob(ws, 'PalmCanopy_BP5_0', -12.98, 5.4, 191.97, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 1.57)
blob(ws, 'PalmCanopy_BP5_1', -14.09, 5.88, 193.88, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, 0.52)
blob(ws, 'PalmCanopy_BP5_2', -16.29, 5.66, 193.87, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -0.53)
blob(ws, 'PalmCanopy_BP5_3', -17.38, 5.06, 191.95, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -1.58)
blob(ws, 'PalmCanopy_BP5_4', -16.26, 4.96, 190.05, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -2.63)
blob(ws, 'PalmCanopy_BP5_5', -14.06, 5.51, 190.08, 3.4, 1.1, 2.0, {46, 138, 58}, Enum.Material.SmoothPlastic, 0, false, 0, 0, -3.68)
blob(ws, 'PalmTop_BP5', -15.18, 5.8, 191.97, 2.6, 1.4, 2.6, {52, 150, 62}, Enum.Material.SmoothPlastic, 0, false)
part(ws, 'PalmNut1_BP5', -15.58, 4.9, 192.27, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
part(ws, 'PalmNut2_BP5', -14.78, 4.9, 191.67, 0.4, 0.4, 0.4, {90, 62, 30}, Enum.Material.SmoothPlastic, 0, false, Enum.PartType.Ball, 0, 0, 0)
...
Config.AUTO_TERRAIN = true -- build real islands at server start (runtime terrain)
